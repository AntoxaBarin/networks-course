...
Логи вида "x y" -- это размер отправленного пакета и остаток байт, которые нужно отправить, соответственно.

![](./images/diff_task_1.png)
...
Клиент и сервер одновременно обмениваются информацией.

![](./images/diff_task_2.png)
